...
date: "2025-06-25"
categories: [r, docker, rmarkdown, reproducibility]
description: >
...
More formally, this post documents the Container layer of the
Workflow Construct described in
[post 52](/posts/52-workflow-construct/), with R Markdown as
the worked example. The Container layer is replaceable across
runtimes (Docker on the laptop, Apptainer on HPC, Podman as a
daemonless alternative); its core machinery (Dockerfile
authoring, base image selection, dependency installation,
port binding) is the same regardless of what the container
ultimately serves. This post is the canonical container-layer
post for the construct;
[post 33](/posts/33-shareshinycodeviadocker/) is a
Shiny-specific case study that defers to this post for layer
fundamentals.
...
![](media/images/docker-logo.png){.img-fluid width=30% fig-align="center"}
